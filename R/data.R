...
#'   \item{category}{Operational category (EFH, HOI, IIH, EIH, CMH, SPH) / Categoria operacional do evento.}
...
#' }
#' @source Processed via data-raw/drilling_processing.R from Sossego Mine telemetry.
"drill_events_mine_d"
